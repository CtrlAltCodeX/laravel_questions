                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        {{-- data.forEach(function(question) { --}}
                            ...
                            console.log(translated_questions);
                                ...
                                translated_questions.forEach(function(translated_question){
                                    ...
                                    var newRow = `
                                        <tr>
                                            ...
                                            <td class="p-2" data-column="image">${translated_question.question.photo}</td>
                            ...
                            var destroyUrl = `{{ route('question.destroy', ':id') }}`.replace(':id', question.id);
                            var newRow = `
                                <tr>
                                    <td class="p-2" data-column="id">
                                        <input type="checkbox" class="select-item" value="${question.id}" />
