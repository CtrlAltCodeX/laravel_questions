...
<div class="flex justify-between">
    ...
    <div class="flex gap-2">
        <form action="{{ route('subject.index') }}" id='paginationForm'>
        ...
        <a href="{{ route('subject.create') }}" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Create</a>
    </div>
</div>
        ...
        <tbody>
            ...
            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                ...
                <td class="px-6 py-4 flex gap-4">
                    <a href="{{ route('subject.edit', $subject->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
