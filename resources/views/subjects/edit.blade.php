...
<form class="max-w-sm mx-auto" method="POST" action="{{ route('subject.update', $subject->id) }}" enctype="multipart/form-data">
    ...
    <div class="relative" style="height: 100px;">
        <div class="container">
            ...
            <img class="inline-block h-8 w-8 rounded-full ring-2 ring-white image" src="{{ $subject->photo ? Storage::url($subject->photo) : '/dummy.jpg' }}" alt="" id='subjectImage' style='width:100px;height:100px;'>
