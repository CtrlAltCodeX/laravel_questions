...
<div class="flex justify-between">
    ...
    <a href="{{ route('subject.export') }}" class="text-center hover:text-white border border-bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
            Export
        </a>
  ...
  <tbody>
            ...
            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                ...
                <button class="editButton font-medium text-blue-600 dark:text-blue-500 hover:underline" 
                    ...
                    data-language-id="{{ $subject->language_id }}" 
                    data-photo="{{ $subject->photo }}"
                    data-category-id="{{ $subject->category_id }}"
                    data-sub-category-id="{{ $subject->sub_category_id }}"
                    > 
