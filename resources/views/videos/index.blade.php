...
<div class="flex justify-between mb-3">
    ...
    <input type="text"  placeholder="Upload/Video Id" id="video_id" name="video_id"
        ...
        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-1/2 p-2.5"
        required /> -->
        <input type="file" accept="application/pdf" id="pdf_input" name="pdf_link" 
    class="hidden"/>
<input type="text" id="pdf_filename" placeholder="Upload PDF" readonly
    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-1/2 p-2.5"/>
<button type="button" onclick="document.getElementById('pdf_input').click()"
    class="bg-blue-500 text-white px-3 py-2 rounded">Choose File</button>
